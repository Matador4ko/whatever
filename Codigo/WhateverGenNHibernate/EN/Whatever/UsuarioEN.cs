...
{
        this.init (ID, nombre, edad, sexo, facebook, instagram, twitter, usuario_reto, usuario_reporte2, usuario_puntuacion, comentario_usuario2, usuario_evento2, contrasena, email, foto);
}


public UsuarioEN(UsuarioEN usuario)
{
        this.init (ID, usuario.Nombre, usuario.Edad, usuario.Sexo, usuario.Facebook, usuario.Instagram, usuario.Twitter, usuario.Usuario_reto, usuario.Usuario_reporte2, usuario.Usuario_puntuacion, usuario.Comentario_usuario2, usuario.Usuario_evento2, usuario.Contrasena, usuario.Email, usuario.Foto);
}
