...
{
/**
 *	Atributo borrarRetos
 */
private string borrarRetos;



/**
 *	Atributo borrarEvento
 */
private string borrarEvento;
...
public virtual string BorrarRetos {
        get { return borrarRetos; } set { borrarRetos = value;  }
}



public virtual string BorrarEvento {
        get { return borrarEvento; } set { borrarEvento = value;  }
}
...
public AdminEN(int iD, string borrarRetos, string borrarEvento, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ReporteEN> admin_reporte2
...
{
        this.init (ID, borrarRetos, borrarEvento, admin_reporte2, nombre, seguidores, edad, sexo, facebook, instagram, historial, usuario_reto, usuario_usuario, usuario_usuario2, usuario_reporte2, usuario_puntuacion, comentario_usuario2, usuario_evento2, contrasena, email, foto);
}


public AdminEN(AdminEN admin)
{
        this.init (ID, admin.BorrarRetos, admin.BorrarEvento, admin.Admin_reporte2, admin.Nombre, admin.Seguidores, admin.Edad, admin.Sexo, admin.Facebook, admin.Instagram, admin.Historial, admin.Usuario_reto, admin.Usuario_usuario, admin.Usuario_usuario2, admin.Usuario_reporte2, admin.Usuario_puntuacion, admin.Comentario_usuario2, admin.Usuario_evento2, admin.Contrasena, admin.Email, admin.Foto);
}

private void init (int ID
                   , string borrarRetos, string borrarEvento, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ReporteEN> admin_reporte2, string nombre, int seguidores, int edad, string sexo, string facebook, string instagram, string historial, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.RetoEN> usuario_reto, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.UsuarioEN> usuario_usuario, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.UsuarioEN> usuario_usuario2, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ReporteEN> usuario_reporte2, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.PuntuacionEN> usuario_puntuacion, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ComentarioEN> comentario_usuario2, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.EventoEN> usuario_evento2, String contrasena, string email, string foto)
{
        this.ID = ID;


        this.BorrarRetos = borrarRetos;

        this.BorrarEvento = borrarEvento;
