...
{
        this.init (ID, numPasos, gymkana_paso, titulo, descripcion, fecha, precio, usuario_evento, puntuacion_evento2, evento_mapa, comentario_evento, reporte_evento2);
}


public GymkanaEN(GymkanaEN gymkana)
{
        this.init (ID, gymkana.NumPasos, gymkana.Gymkana_paso, gymkana.Titulo, gymkana.Descripcion, gymkana.Fecha, gymkana.Precio, gymkana.Usuario_evento, gymkana.Puntuacion_evento2, gymkana.Evento_mapa, gymkana.Comentario_evento, gymkana.Reporte_evento2);
}

private void init (int ID
                   , int numPasos, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.PasoEN> gymkana_paso, string titulo, string descripcion, Nullable<DateTime> fecha, int precio, WhateverGenNHibernate.EN.Whatever.UsuarioEN usuario_evento, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.PuntuacionEN> puntuacion_evento2, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.MapaEN> evento_mapa, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ComentarioEN> comentario_evento, System.Collections.Generic.IList<WhateverGenNHibernate.EN.Whatever.ReporteEN> reporte_evento2)
{
        this.ID = ID;
